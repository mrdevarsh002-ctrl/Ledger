...
import { Search, Edit2, Trash2, History, TrendingUp, TrendingDown, User, Building2, Download } from 'lucide-react';
      ...
      <div className="mb-4">
        <div className="flex gap-2 mb-3">
          ...
          <motion.button
            ...
            className={`h-12 px-4 rounded-xl flex items-center justify-center gap-2 transition-all ${
              isDark
